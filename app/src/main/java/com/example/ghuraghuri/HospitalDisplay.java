...
public class HospitalDisplay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nothing=findViewById(R.id.hosp_noth);
        recyclerView=findViewById(R.id.hosp_recView);
        progressBar=findViewById(R.id.pr_hosp);
    ...
    void getHospitalInfo()
    {
        ...
        DatabaseReference ref= FirebaseDatabase.getInstance().getReference()
                .child("Places").child(place_id).child("Hospital");
    ...
    void setInfo()
    {
        ...
        else
        {
            ...
            adapter=new ListAdapter(HospitalDisplay.this);
